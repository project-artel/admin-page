...
Before designing or changing React UI, read `.agents/docs/DESIGN.md` and follow
its semantic tokens, layouts, components, states, and accessibility rules unless
